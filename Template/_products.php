...
if($_SERVER['REQUEST_METHOD'] == "POST"){
    if (isset($_POST['top_sale_submit'])){
        ...
        $Cart->addToCart('1', $_POST['item_id']);
    }
}
        ...
        <div class="row">
            <div class="col-sm-6">
                ...
                <div class="form-row pt-4 font-size-16 font-baloo">
                    <div class="col">
                        <a href="order.php" class="btn btn-danger form-control">Proceed to Buy</a>
                    </div>
                    <div class="col">
                    <form method="post">
